...
alter table geolocalizzazione add column v character varying;
update geolocalizzazione set v = o.via from vie o where geolocalizzazione.via = o.osm_id;
alter table geolocalizzazione drop column via ;
alter table geolocalizzazione rename COLUMN v TO via;
